	...
	function GetList()
	{
		...
		else
		{
			...
			else
			{
				...
				$pagetxt .= '<a href="javascript:;" title="已是第一页">上一页</a>';
			}
			...
			if($this->page < $this->totalpage)
			{
				   ...
				   !isset($keyword))
				{
					...
					$pagetxt .= '<a href="'.$nowurl.'-'.$this->totalpage.'.html" title="末页">末页</a>';
				}
				else
				{
					$pagetxt .= '<a href="'.$nowurl.'page='.$next.'" title="下一页">下一页</a>';
					$pagetxt .= '<a href="'.$nowurl.'page='.$this->totalpage.'" title="末页">末页</a>';
				}
			}
			else
			{
				$pagetxt .= '<a href="javascript:;" title="已是最后一页">下一页</a>';
				$pagetxt .= '<a href="javascript:;" title="已是最后一页">末页</a>';
			}
			$pagetxt .= '</div>';
		}
